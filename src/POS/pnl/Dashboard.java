    ...
    private void initComponents() {
        ...
        pnl_holder_searchLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl_holder_searchLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_charge_to_room)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnl_holder_searchLayout.setVerticalGroup(
            ...
            .addComponent(btn_charge_to_room, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cb_table_location, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_clear_all)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tf_barcode, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btn_expenses, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_remit, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_pay, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_standby, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//                int room_guest_id=tg.room_guest_id;
                Dlg_check_liquid.to_guests ti=new Dlg_check_liquid.to_guests(id, name, status);
                datas2.add(ti);
            }
...
//        Application.locateOnParentCenter(w, d);
    ...
    private void process_pay(CloseDialog cd, Dlg_pay.OutputData data, final to_disc to1, final int a, final to_credit to2, final int b, final String member_id, double dollar_rate, double dollar_tendered, double peso) {
        ...
        if (a == 0) {
            Svc_1.pay2(tp, lbl_cashier_name.getText(), to1, to2, b, member_id, my_guest, tbl_no, user_id, lbl_or_no.getText()
                    , tbl_location_id, peso,lbl_table_no.getText());
        } else {
            Svc_1.pay(tp, lbl_cashier_name.getText(), to1, to2, b, member_id, my_guest, tbl_no, user_id, lbl_or_no.getText(), tbl_location_id, peso,lbl_table_no.getText());
        }
    ...
    private void prepare_order2() {
        ...
        for (S5_printing_assemlby.to_printing_assembly t : datas) {
            ...
            if (t.place.equalsIgnoreCase("NORMAL")) {
                ...
                rpt_orders rpt = new rpt_orders(table_name + " (" + cb_table_location.getSelectedItem().
                        toString() + ")", t.place,
                        to_users.username1);
                int state = 0;
                if (ui_items.equals("list")) {
