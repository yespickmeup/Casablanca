...
//            validateTree();
    ...
    private void initComponents() {
        ...
        tf_dollar.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        jPanel1.add(tf_dollar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 290, 50));
...
//        JOptionPane.showMessageDialog(null, OutputData.);
    ...
    private void clear_field() {
        if (tf_dummy.hasFocus()) {
            Backspace.clear_lbl(lbl_cashcount);
            tf_dummy.setText(lbl_cashcount.getText());
        } else {
            Backspace.clear_lbl(tf_dollar);
            tf_dummy1.setText(tf_dollar.getText());
        }
    }
    public String user = "";
...
//                btn_dot.doClick();
    ...
    private void initTfDummy() {
        ...
        tf_dummy1 = new JTextField();
        CurrencyDocument cd1 = new CurrencyDocument(true, 10);
        tf_dummy1.setDocument(cd1);
    }
    private JTextField tf_dummy;
    private JTextField tf_dummy1;

    private void put_text(String str) {

        if (lbl_cashcount.hasFocus()) {
            CurrencyDocument.decimalInserter(tf_dummy, str);
            lbl_cashcount.setText(tf_dummy.getText());
        } else {
            CurrencyDocument.decimalInserter(tf_dummy1, str);
            tf_dollar.setText(tf_dummy1.getText());
        }
    }
    //</editor-fold>
...
//        lbl_cashcount.setText("");
    ...
    private void prcss_work_on() {
        ...
        double addtl_cash = FitIn.toDouble(tf_dollar.getText());
